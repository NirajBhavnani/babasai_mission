...
class FormTy extends StatefulWidget {
  @override
  _FormTyState createState() => _FormTyState();
}

class _FormTyState extends State<FormTy> with AutomaticKeepAliveClientMixin<FormTy>{
  ...
  Map<String, bool> subjects = {
    ...
    'Sindhi': false,
    'Marathi': false,
    'Marketing Research': false,
    'Export Management': false,
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                TextFormField(
                  decoration: InputDecoration(labelText: 'Standard', hintText: 'For TY, put std as 15'),
