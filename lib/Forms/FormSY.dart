...
class FormSy extends StatefulWidget {
  @override
  _FormSyState createState() => _FormSyState();
}

class _FormSyState extends State<FormSy> with AutomaticKeepAliveClientMixin<FormSy>{
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                TextFormField(
                  decoration: InputDecoration(labelText: 'Standard', hintText: 'For SY, put std as 14'),
